...
import { X, Calendar, Clock, Video, MapPin, Link2, Sparkles } from "lucide-react";
...
export default function ScheduleInterviewModal({
  ...
  const isFormValid = selectedDate && time && (type === "Online" ? meetingLink : location);
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 24 }}>
          <div>
            ...
            <p style={{ margin: "4px 0 0", fontSize: 13, color: "#64748b" }}>
              Set up a date and time with the candidate
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        {/* CSS للتأكد من تنسيق Datepicker مثل باقي المدخلات تماماً */}
        <style>{`
